...
import { Activity, ArrowLeft, BarChart3, Cloud, LayoutDashboard, Mail, Megaphone, Radio, Settings2, ShieldCheck, Trophy, Users } from "lucide-react";
...
const navItems = [
    ...
    { to: "/admin/observability", label: "调用与告警", icon: Activity, exact: false },
    { to: "/admin/channels", label: "渠道管理", icon: Radio, exact: false, superOnly: true },
    { to: "/admin/users", label: "用户管理", icon: Users, exact: false, superOnly: true },
    { to: "/admin/contest", label: "大赛审核", icon: Trophy, exact: false },
    { to: "/admin/usage", label: "用量统计", icon: BarChart3, exact: false },
